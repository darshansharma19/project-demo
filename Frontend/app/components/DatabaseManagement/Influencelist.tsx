...
interface Influencers_Data {
    fieldName: string;
    dataType: string;
  }

const Influencerlist = () => {
    const entries: Influencers_Data[] = [
      ...
      const [newField, setNewField] = useState<Influencers_Data>({
        fieldName: "",
        dataType: "",
      });
      ...
      return (
        <div>
          <div className="border-box max-w-full flex justify-between items-center">
            <div className="text-[22px] font-[700]">Influencers</div>
