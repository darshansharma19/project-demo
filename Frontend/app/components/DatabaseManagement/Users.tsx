...
const Users = () => {
    ...
    { fieldName: "Full Name", dataType: "String" },
    { fieldName: "Uid", dataType: "String" },
    { fieldName: "Email", dataType: "String" },
    { fieldName: "Display_Name", dataType: "String" },
    { fieldName: "Password", dataType: "String" },
    { fieldName: "Created_time", dataType: "Data_Time" },
    { fieldName: "Phone_number", dataType: "String" },
    { fieldName: "Phone_url", dataType: "Img_Path" },
  ];
  const [data, setData] = useState(entries);
  const [newField, setNewField] = useState<UserData>({
    fieldName: "",
    dataType: "",
  });
  ...
  return (
    <div>
      ...
      <table className="min-w-full p-6 overflow-hidden">
        <thead className=" border-black dark:border-white  border-b border-solid">
