    ...
    switch (chartactiveOption) {
      case 'Weekly':
        ...
        <div className="relative w-[400px] flex flex-col items-start justify-start gap-[1rem] text-right text-[0.88rem] text-gray-03 font-regular-14-20">
          ...
          <div className="w-[3rem] relative leading-[1.25rem] inline-block shrink-0">$250k</div>
          ...
          <div className="w-[3rem] relative leading-[1.25rem] inline-block shrink-0">$50k</div>
          <div className="w-full relative box-border h-[0.06rem] border-t-[1px] border-solid border-gray-06" />
          </div>
          <div className="flex flex-row items-center justify-start gap-[1rem] z-[2]">
          <div className="w-[3rem] relative leading-[1.25rem] inline-block shrink-0">$10k</div>
          <div className="w-full relative box-border h-[0.06rem] border-t-[1px] border-solid border-gray-06" />
          </div>
          <div className="flex flex-row items-center justify-start gap-[1rem] z-[3]">
          <div className="w-[3rem] relative leading-[1.25rem] inline-block shrink-0">$2k</div>
          <div className="w-full relative box-border h-[0.06rem] border-t-[1px] border-solid border-gray-06" />
          </div>
          <div className="flex flex-row items-center justify-start gap-[1rem] z-[4]">
          <div className="w-[3rem] relative leading-[1.25rem] inline-block shrink-0">$0</div>
          <div className="w-full relative box-border h-[0.06rem] border-t-[1px] border-solid border-gray-06" />
          </div>
          ...
          <div className="w-[3.25rem] relative leading-[1.25rem] inline-block">17 Sun</div>
          </div>
          ...
          <div className="w-[3.25rem] relative leading-[1.25rem] inline-block">18 Mon</div>
          </div>
          <div className="flex flex-col items-center justify-start gap-[0.63rem]">
          <div className="flex flex-row items-end justify-start gap-[0.5rem]">
          <div className="w-[1rem] relative rounded-t rounded-b-none bg-gray-05 h-[6.69rem]" />
          ...
          <div className="w-[3.25rem] relative leading-[1.25rem] inline-block">19 Tue</div>
          </div>
          <div className="flex flex-col items-center justify-start gap-[0.63rem]">
          <div className="flex flex-row items-end justify-start gap-[0.5rem]">
          <div className="w-[1rem] relative rounded-t rounded-b-none bg-gray-05 h-[6.69rem]" />
          ...
          <div className="w-[3.25rem] relative leading-[1.25rem] inline-block">20 Wed</div>
          </div>
          <div className="flex flex-col items-center justify-start gap-[0.63rem]">
          <div className="flex flex-row items-end justify-start gap-[0.5rem]">
          ...
          <div className="w-[3.25rem] relative leading-[1.25rem] inline-block">21 Thu</div>
          </div>
          <div className="flex flex-col items-center justify-start gap-[0.63rem]">
          <div className="flex flex-row items-end justify-start gap-[0.5rem]">
          ...
          <div className="w-[3.25rem] relative leading-[1.25rem] inline-block">22 Fri</div>
          </div>
          {/* <div className="flex flex-col items-center justify-start gap-[0.63rem]">
          <div className="flex flex-row items-end justify-start gap-[0.5rem]">
  ...
  return ( 
    <div className="flex bg-special-bg dark:bg-black-dark w-full min-h-screen">
      ...
      <div className="w-full mx-6  my-8 flex flex-col ">
        ...
        <div className="relative text-[2.25rem] dark:text-white py-6 font-semibold font-geist">Dashboard</div>
              ...
              <div className=" relative cursor-pointer w-[300px] h-60  dark:text-white flex flex-col items-start justify-start text-left text-gray-800 ]">
                {/* Content for Dashboard */}
                    ...
                    {/* Dashboard Content */}
                        ...
                        <div className="leading-8 font-header-22-32 text-gray-02 text-left">Total app Downloads</div>
              ...
              <div className="relative rounded-lg flex flex-col items-center shadow-md bg-white dark:bg-gray-200 w-full h-[14.5rem]">
                ...
                <div className="relative rounded-lg flex flex-row bg-mediumblue dark:bg-mediumpurple w-[265px]  h-[8.13rem]" >
                          ...
                          <div className="w-1/2 border-l border-white border-solid pt-2 flex flex-col">
                            ...
                            <div className="w-[7.94rem] relative text-[1.28rem] pt-2 leading-[2rem] font-header-22-32 text-white text-center inline-block">android app downloads</div>
                          </div>
                </div>
              </div>
                          ...
                          <div className="flex flex-col items-center justify-start gap-[0.88rem] text-center text-gray-04">
                            <div className="shrink-0 flex flex-col items-center justify-start gap-[0.38rem]">
                              <div className=" shrink-0 w-full h-16 flex flex-col items-center justify-start">
                                <div className="relative shrink-0 flex w-full h-full flex-col items-start justify-start">
                                    <img className="relative rounded-lg  h-16 object-cover" alt="" src="/assets/Ellipse23.svg" />
                                    <img className="absolute rounded-lg  h-16 object-cover -top-5.87rem" alt="" src="/assets/Ellipse24.svg" />
                                </div>
                                <img className="relative my-0 mx-[!important] w-9 h-9 object-cover mt-[-2.31rem]" alt="" src="/assets/Meter.svg" />
                              </div>
                            ...
                            <div className="relative leading-[1rem] text-[10px] font-medium text-default-black text-left">Target vs Achievement</div>
                          </div>
                        </div>
                      {/* // yha tak  */}
                    </div>
                  ...
                  {/* Partners Content */}
                    ...
                    <div className="relative rounded-lg p-2 bg-white dark:bg-gray-200 dark:text-white shadow-md w-full h-[14.5rem] flex flex-col items-start justify-start  box-border text-center text-[0.75rem] text-gray-01 font-bold-16-24">
                      ...
                      <div className="w-full box-border flex flex-row items-center justify-between pt-[0.5rem] px-[0rem] pb-[1.25rem] border-b-[1px] border-solid border-gray-06">
                        ...
                        <div className="w-[1.75rem] relative leading-[1rem] font-medium inline-block">May</div>
                        </div>
                        ...
                        <div className="w-[10rem] relative text-[0.75rem] leading-[1rem] text-gray-03 inline-block"> From- 14 June-14 May</div>
                        </div>
                        </div>
                        </div>
                        ...
                        <b className="w-[2.75rem] relative leading-[1.5rem] capitalize inline-block shrink-0">150</b>
                        </div>
                      </div>
                      <div className="w-full flex flex-row items-center justify-between pt-[1.25rem] px-[0rem] pb-[0.25rem] box-border">
                        ...
                        <div className="rounded-lg bg-white flex flex-row items-start justify-start py-[0.5rem] px-[0.75rem] text-[1rem] text-secondary border-[1px] border-solid border-gray-05">
                        <b className="w-[2.75rem] relative leading-[1.5rem] capitalize inline-block shrink-0">559</b>
                        </div>
                      </div>
                      {/* yha tak */}
                    </div>
...
<div className='flex flex-row gap-12'>
          ...
          <div className='flex flex-col w-full pt-8 pr-12 gap-2 text-left text-[1.38rem] text-gray-02   font-regular-12-16'>
              ...
              <div className="relative rounded-lg w-full flex flex-row items-start justify-start py-[0.5rem] px-[1rem] box-border gap-[1rem] text-left text-[0.75rem] text-gray-02 font-medium-12-16">
                ...
                <img className="w-full relative max-w-full overflow-hidden h-[1.5rem]" alt="" src="/assets/googlemaps.svg" />
                <div className="flex flex-col items-start justify-start">
                <div className="flex flex-col items-start justify-start">
                <div className="w-[5.5rem] relative leading-[1rem] font-medium inline-block h-[1.13rem] shrink-0">{`Maps `}</div>
                <b className="w-[5.5rem] relative text-[1rem] leading-[1.5rem] capitalize inline-block text-default-black">2500</b>
                </div>
                <div className="rounded-2xl flex flex-row items-center justify-start gap-[0.5rem] text-gray-03">
                <div className="relative leading-[1rem] font-medium">15%*</div>
                <img className="w-[1rem] relative h-[1rem] overflow-hidden shrink-0" alt="" src="/assets/Up-arrow.svg" />
                </div>
                </div>
                <img className="w-[1.5rem] relative h-[1.5rem] overflow-hidden shrink-0 opacity-[0.5]" alt="" src="/assets/Group-7.svg" />
                </div>
              </div>
