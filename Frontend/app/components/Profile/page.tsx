...
const Profile = () => {
  ...
  const handleUpload = async () => {
    if (image) {
      ...
      try {
        await uploadBytes(storageRef, image); // upload image to firebase store
          ...
          <div className="flex p-8 w-1/2 flex-col">
            ...
            <div className="flex flex-row gap-9 items-center">
              <img
                ...
                alt=""
                src={user?.photoURL || "/assets/Ellipse-1.svg"}
              />
              <input
                type="file"
            ...
            <form action="" className="my-8 mx-2 w-80">
              ...
              <div className="shrink-0 flex w-80 flex-col items-start justify-start gap-[0.5rem]">
                <div className="relative leading-[1.5rem] font-segoe-ui text-tertiary font-medium inline-block overflow-hidden shadow-sm text-ellipsis whitespace-nowrap shrink-0">
                  Full Name
                </div>
                <input
                  type="Name"
              ...
              <div className="relative leading-6  font-segoe-ui text-tertiary font-medium inline-block overflow-hidden shadow-sm text-ellipsis whitespace-nowrap shrink-0">
                Savings/Coin
              </div>
          ...
          <div className="flex p-8 w-1/2 flex-col">
            ...
            <div className="relative flex flex-row gap-7 w-full h-[6.19rem] text-left text-[0.75rem] text-tertiary font-segoe-ui">
              <div className="flex flex-col pl-2 gap-1 w-2/3">
                <b className="relative text-[0.88rem] leading-6 font-segoe-ui text-tertiary text-left">
                  Sea Grill of Merrick Park
                </b>
                <div className="relative text-[0.75rem] leading-5 font-segoe-ui text-mediumblue dark:text-mediumpurple text-left">
                  Reserved
                </div>
                <div className="relative w-full h-[1.25rem] text-left text-[0.75rem] text-tertiary font-segoe-ui">
                  <img
                    ...
                    alt=""
                    src="/assets/material-symbols_date-range.svg"
                  />
                  <b className="absolute top-[0.06rem] left-[2.19rem]">
                ...
                <div className="relative w-full h-[1.25rem] text-left text-[0.75rem] text-tertiary font-segoe-ui">
                  <img
                    className="absolute top-[0rem] left-[0rem] w-[1.25rem] h-[1.25rem]"
                    alt=""
                    src="/assets/mdi_person-multiple.svg"
                  />
                  <b className="absolute top-[0.06rem] left-[2.19rem]">
                    2 Guests
                  </b>
              ...
              <div className="flex flex-col pr-2 justify-start gap-1 w-1/3">
                ...
                <div className="relative text-[0.63rem] leading-5 [text-decoration:underline] font-segoe-ui text-deeppink text-right">
                  Cancel Booking
                </div>
                <b className="relative text-[0.75rem] font-segoe-ui text-tertiary text-right">
                  Saved : $2
                </b>
              </div>
            </div>
            ...
            <div className="relative flex flex-row gap-7 w-full h-[6.19rem] text-left text-[0.75rem] text-tertiary font-segoe-ui">
              <div className="flex flex-col pl-2 gap-1 w-2/3">
                ...
                <div className="relative text-[0.75rem] leading-5 font-segoe-ui text-deeppink text-left">
                  Cancelled
                </div>
                <div className="relative w-full h-[1.25rem] text-left text-[0.75rem] text-tertiary font-segoe-ui">
                  <img
              ...
              <div className="flex flex-col pr-2 gap-1 w-1/3">
                ...
                <div className="relative text-[0.63rem] leading-5 [text-decoration:underline] font-segoe-ui text-transparent text-right">
                  {" "}
                  ads{" "}
                </div>
                <b className="relative text-[0.75rem] font-segoe-ui text-tertiary text-right">
            ...
            <Link
              href=""
              className="relative w-full h-[2.5rem] text-center text-[1rem] text-white font-segoe-ui"
            >
              <div className="absolute top-[0rem] left-[0rem] rounded bg-mediumblue dark:bg-mediumpurple w-96 h-[2.5rem]" />
              <b className="absolute top-[0.5rem] left-[0.11rem] leading-[1.5rem] inline-block w-[400px]">
                Save/Update Details
              </b>
            </Link>
          </div>
